...
/**
 *
 * tạo token mới từ username và phân giải token từ client gửi lên
 */
...
public class JwtService {
    ...
    public static final String SECRET_KEY = "%&$(##JFDKJLk4d5sd48wdfjkd*$(F)JF>?<F?><>+++++-*/klf454";
    public static final byte[] SHARED_SECRET_KEY = SECRET_KEY.getBytes();
    //thời gian token hiệu lực
    public static final int EXPIRE_TIME = 86400000;

    //tạo token từ username; quá trình tạo token để gửi về client
    ...
    //bóc tách token để lấy thông tin username
